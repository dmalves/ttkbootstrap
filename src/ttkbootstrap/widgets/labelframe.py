...
# TODO make sure to test the label widget functionality


class Labelframe(Widget, ttk.Labelframe):
    def __init__(self, master=None, bootstyle='default', **kwargs):
        Widget.__init__(self, bootstyle, 'TLabelframe')
    ...
    def _configure_bootstyle(self, *args):
        ...
        if not self._theme.style_exists(self._ttkstyle):
            builder.create_labelframe_style(self)
