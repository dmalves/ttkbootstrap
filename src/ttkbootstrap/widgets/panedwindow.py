...
class Panedwindow(Widget, ttk.Panedwindow):
    def __init__(self, master=None, bootstyle='default', orient=VERTICAL, **kwargs):
        Widget.__init__(self, bootstyle, 'TPanedwindow', orient)
        ttk.Panedwindow.__init__(self, master=master, orient=orient, **kwargs)
    ...
    def _configure_bootstyle(self, *args):
        ...
        if not self._theme.style_exists(self._ttkstyle):
            builder.create_panedwindow_style(self)
